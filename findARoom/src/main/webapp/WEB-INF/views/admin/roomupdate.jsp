            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Available</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
          ...
          <div class="row">
            ...
            <div class="col">
              <div class="card shadow mb-4">
                ...
                <form action="${cp }/admin/room/edit" method="post">
				...
				<c:choose>
				<c:when test="${room.id eq roominfo.id }">
                  <option value="${room.id }" selected > ${room.id }-> &nbsp; ${room.type} &nbsp;(${room.area}sqft)</option>
                </c:when>
                <c:otherwise>
                  <option value="${room.id }" > ${room.id }-> &nbsp; ${room.type} &nbsp;(${room.area}sqft)</option>
                </c:otherwise>
                </c:choose>
                </c:forEach>
				</select> &nbsp; &nbsp; &nbsp; &nbsp;
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                <form action="${cp }/admin/room/update" method="post">
                <table>
                ...
                <td>
				<input type="text" class="from-control" name="id" value="${roominfo.id }" readonly>
				...
				<input type="text" class="from-control" name="type" value="${roominfo.type }" >
                ...
                <td>
				<input type="text" class="from-control" name="area" value="${roominfo.area }" >
              ...
              <td>
                ...
                <td>
				<input type="text" class="from-control" name="description" value="${roominfo.description }" >
                </td>
                </tr>
                <tr>
                <td>
                ...
                <td>
				<input type="text" class="from-control" name="rooms" value="${roominfo.rooms }" >
               </td>
              </tr>
              <tr>
 <td>
                ...
                <td>
				<input type="text" class="from-control" name="status" value="${roominfo.status }" >
             ...
             <td>
                ...
                <td>
				<input type="text" class="from-control" name="verify" value="${roominfo.verify }" >
               </td>
               </tr>
               ...
               <td>
                ...
                <td>
				<input type="text" class="from-control" name="price" value="${roominfo.price }" >
              </td>
              </tr>
                </table>
