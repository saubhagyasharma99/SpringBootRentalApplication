            ...
            <div class="col">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <!-- // delete admin or  -->
                  <c:if test="${user.roles.role eq 'ROLE_ADMIN' }">
                  <form action="${cp}/admin/admin/delete" method="post">
                  <input type="hidden" name="adminId" value="${user.id}">
                  <input type="submit" value="Delete Admin">
                  </form>
                  </c:if>
                  <!--// delete owner -->
                  <c:if test="${user.roles.role eq 'ROLE_OWNER' }">
                  <form action="${cp}/admin/owner/delete" method="post">
                  <input type="hidden" name="ownerId" value="${user.id}">
                  <input type="submit" value="Delete Owner">
                  </form>
                  </c:if>
                  <!--// delete user -->
                  <c:if test="${user.roles.role eq 'ROLE_USER' }">
                  <form action="${cp}/admin/user/delete" method="post">
