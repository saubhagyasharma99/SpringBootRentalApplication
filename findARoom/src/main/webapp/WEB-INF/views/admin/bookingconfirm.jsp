       ...
       <jsp:include page="navbar.jsp"></jsp:include>
        ...
        <div class="container-fluid">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">4533</div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">3972</div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">2091</div>
                        </div>
                        <div class="col">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Verified</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">593</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Displaying All Bookings of a Room</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  ...
                  <td>${booking.room.rooms }</td>
                  <td>${booking.user.firstName } &nbsp; ${booking.user.lastName }</td>
                  <td>${booking.profession }</td>
                  <td>${booking.occupancy }</td>
                  <td>${booking.remark}</td>
                  <td>
                  <a href="${cp}/admin/booking/detail/${booking.id}">View Detail</a>
                  <a href="${cp}/admin/booking/confirm/${booking.id}">Confirm</a>
                  <a href="${cp}/admin/booking/delete/${booking.id}">Delete</a>
                  </td>
                  </tr>
                  </c:forEach>
                  </tbody>
         ...
         <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Booking confirmed by the owner</h6>
                </div>
                <div class="card-body">
                 <table class="table table-responsive table-striped">
                  <thead>
                  ...
                  <tbody>
                  <c:forEach items="${confirmedlist }" var="booking">
                  <tr>
                  <td>${booking.room.type }</td>
                  <td>${booking.room.rooms }</td>
                  <td>${booking.user.firstName } &nbsp; ${booking.user.lastName }</td>
                  ...
                  <td>${booking.remark}</td>
                  <td>
                  <a href="${cp}/admin/notify/user/${booking.id}">Notify User</a>
                  <a href="${cp}/admin/notify/owner/${booking.id}">Notify Owner</a>
                  <a href="${cp}/admin/booking/success/${booking.id}">Finalize</a>
                  </td>
                  </tr>
                  </c:forEach>
                  </tbody>
