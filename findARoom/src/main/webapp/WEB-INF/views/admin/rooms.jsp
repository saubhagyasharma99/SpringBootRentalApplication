                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">2337</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Displaying All Rooms</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  ...
                  <td>${room.price}</td>
                  <td>
                  <a href="${cp}/admin/room/detail/${room.id}">View Detail</a>
                  <a href="${cp}/admin/room/bookings/${room.id}">Bookings</a>
                  <a href="${cp}/admin/room/delete/${room.id}">Delete</a>
                  </td>
                  </tr>
                  </c:forEach>
                  </tbody>
